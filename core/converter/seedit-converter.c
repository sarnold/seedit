...
const char usage[]= "Usage : seedit-converter [-t] [-p] -i <infile> -b <base policy dir> -o <output dir> --profile-data <attribute profile file> [--busybox]\n" \
	...
	"	--busybox Output busybox_contexts";
...
int main(int argc, char **argv){
  ...
  while ((ch = getopt_long(argc, argv, "\xfe:t:po:i:b:I:\xfd", long_options, 
			   &option_index)) != EOF) {
	  switch (ch) {
	  case 't':
		  level = atoi(optarg);
