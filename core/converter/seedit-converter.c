...
const char usage[]= "Usage : seedit-converter [-t] [-p] -i <infile> -b <base policy dir> -o <output dir> --profile-data <attribute profile file>\n" \
	...
	"	--out-file_type_trans-context: output label-file relationship for files that are labeled by file_type trans. \n" ;
...
int main(int argc, char **argv){
  ...
  while ((ch = getopt_long(argc, argv, "\xfe:t:po:i:b:I:\xfd\xff\xfc", long_options, 
			   &option_index)) != EOF) {
	  switch (ch) {
	  case 't':
		  level = atoi(optarg);
