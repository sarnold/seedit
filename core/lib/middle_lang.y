...
TYPE_DEF: TYPE IDENTIFIER ';'{register_type($2);}

DOMAIN_DEF  : DOMAIN IDENTIFIER ';' {register_domain($2,0); }
;

BODY_DEFS :ALLOW_DEF|DENY_DEF|ALLOWNET_DEF|ALLOWCOM_DEF|ALLOWPRIV_DEF|ALLOWFS_DEF|ALLOWDEV_DEF|INCLUDE_DEF|ALLOWTMP_DEF|ALLOWKEY_DEF|TYPE_DEF
          |BODY_DEFS ALLOW_DEF
          |BODY_DEFS DENY_DEF
