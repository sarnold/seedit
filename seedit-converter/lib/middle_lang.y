 ...
 * All Rights Reserved, Copyright (C) 2003, Hitachi Software Engineering Co., Ltd.
 (c)2005-2006 Yuichi Nakamura ynakam@gwu.edu
 */
...
BODY_DEFS :ALLOW_DEF|DENY_DEF|ALLOWNET_DEF|ALLOWCOM_DEF|ALLOWPRIV_DEF|ALLOWFS_DEF|ALLOWDEV_DEF|INCLUDE_DEF|ALLOWTMP_DEF
          |BODY_DEFS ALLOW_DEF
          |BODY_DEFS DENY_DEF
